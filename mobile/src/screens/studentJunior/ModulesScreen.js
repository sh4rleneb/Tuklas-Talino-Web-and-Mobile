...
export default function ModulesScreen({ navigation }) {
  ...
  const subjects = useMemo(() => {
    ...
    return ['Lahat', ...Array.from(unique)];
  }, [modules]);

  const filteredModules = useMemo(() => {
    if (selectedSubject === 'Lahat') return modules;
        ...
        <View style={styles.lessonTopRow}>
          ...
          <View
            style={[
              ...
              lesson.completed
                ? styles.statusDone
                : styles.statusSimulan,
            ]}
          >
            <Text style={styles.statusText}>
              {lesson.completed ? '✅ Tapos Na' : '▶ Simulan'}
            </Text>
          </View>
        </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyCard}>
              ...
              <Text style={styles.emptyTitle}>Walang nahanap na aralin</Text>
              <Text style={styles.emptySubtitle}>Subukan ang ibang paksa o i-refresh ang pahina.</Text>
            </View>
          }
        />
      )}

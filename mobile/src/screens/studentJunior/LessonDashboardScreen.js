    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.page}>
        ...
        <TouchableOpacity style={styles.backRow} onPress={() => navigation.goBack()}>
          <Text style={styles.backText}>← Lesson Library</Text>
        </TouchableOpacity>
        ...
        <View style={styles.statsRow}>
          <View style={styles.statCard}>
            ...
            <Text style={styles.statLabel}>{activityCount === 1 ? 'Activity' : 'Activities'}</Text>
          </View>
          <View style={styles.statCard}>
            <Text style={styles.statIcon}>⚡</Text>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statLabel}>{isCompleted ? 'Done' : 'Progress'}</Text>
          </View>
        </View>
        ...
        {!layunin && !!lesson.description && (
          <View style={styles.card}>
            <Text style={styles.cardHeading}>📖 About this Lesson</Text>

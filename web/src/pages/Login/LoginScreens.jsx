    ...
    <div className="login-stage teacher-stage">
      <div className="login-shell teacher-shell">
        ...
        <section className="login-form-panel teacher-form-panel">
          <h2 className="teacher-login-blue-title">Mag-login, Guro!</h2>
